    ...
    public sealed class DBMembershipProvider : MembershipProvider
    {
          ...
          string newPwdAnswer)
        {
            ...
            using(DBHelper obj = new DBHelper(ConnectionStrings.DefaultDBConnection))
            {
                ...
                obj.AddParameter("@returnValue", SqlDbType.Int, 0).Direction = ParameterDirection.ReturnValue;
                obj.AddParameter("@question", SqlDbType.NVarChar, 255).Value = newPwdQuestion;
                obj.AddParameter("@answer", SqlDbType.NVarChar, 255).Value = EncodePassword(newPwdAnswer);
                obj.AddParameter("@username", SqlDbType.NVarChar, 255).Value = username; ;
                sqlCommand.Parameters.Add("@applicationName", SqlDbType.NVarChar, 255).Value = applicationName;
            }
            SqlConnection sqlConnection = new SqlConnection(connectionString);
